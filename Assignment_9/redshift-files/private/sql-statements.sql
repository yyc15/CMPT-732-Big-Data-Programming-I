...
COPY amenities FROM 's3://public-cmpt-732/amenities/'
IAM_ROLE 'arn:aws:iam::663547858589:role/RedshiftS3Full'
FORMAT JSON 'auto';
...
COPY customers FROM 's3://public-cmpt-732/customers/'
IAM_ROLE 'arn:aws:iam::663547858589:role/RedshiftS3Full'
FORMAT AS CSV;
...
COPY paymentmethods FROM 's3://public-cmpt-732/paymentmethods/'
IAM_ROLE 'arn:aws:iam::663547858589:role/RedshiftS3Full'
FORMAT AS CSV;
...
COPY purchases FROM 's3://public-cmpt-732/purchases/'
IAM_ROLE 'arn:aws:iam::663547858589:role/RedshiftS3Full'
FORMAT AS CSV;
...
COPY greater_vancouver_prefixes FROM 's3://public-cmpt-732/redshift-tables/greater_vancouver_prefixes.csv'
IAM_ROLE 'arn:aws:iam::663547858589:role/RedshiftS3Full'
FORMAT AS CSV;
...
STORED AS TEXTFILE
LOCATION 's3://public-cmpt-732/ext-purchases/';
...
LOCATION 's3://public-cmpt-732/amenities/';
